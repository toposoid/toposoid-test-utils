...
import com.ideal.linked.toposoid.common.{CLAIM, DOCUMENT, IMAGE, Neo4JUtilsImpl, PREMISE, PROPOSITION_ID, SENTENCE, TITLE_OF_TOP_PAGE, ToposoidUtils, TransversalState, UNSPECIFIED}
